...
<?php
	...
	echo '<input type="hidden" id="levelObject" value="' . htmlspecialchars($currentLevel['levelObject']) . '">';
?>
				...
				<div class="xWrapper">
					<?php
						if(is_null($nextLevel))
							...
							echo '<a class="button gray" href="play.php?creatorNickname=' . $nextLevel['creatorNickname'];
							echo '&levelName=' . $nextLevel['name'] .'">Next Level</a>';
						}
					?>
